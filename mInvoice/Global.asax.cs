...
namespace mInvoice
{
    ...
    public class DateTimeModelBinder : IModelBinder
    {
        ...
        public object BindModel(ControllerContext controllerContext,
            ModelBindingContext bindingContext)
        {
            ValueProviderResult _day = bindingContext.ValueProvider.GetValue(bindingContext.ModelName + ".Day");
            ValueProviderResult _month = bindingContext.ValueProvider.GetValue(bindingContext.ModelName + ".Month");
            ValueProviderResult _year = bindingContext.ValueProvider.GetValue(bindingContext.ModelName + ".Year");

            //ValueProviderResult valueResult = new ValueProviderResult();
            ...
            ValueProviderResult valueResult = new ValueProviderResult(actualValue, actualValue.ToString(), CultureInfo.CurrentCulture);
